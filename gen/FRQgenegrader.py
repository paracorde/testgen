import openai
generatorPrompt = '''Given the information above create a plausible multiple choice question with 4 choices and the index of the correct choice at the end. Do this all in a single line without option letters. Ensure your response is always formatted like this: 'question;option1;option2;option3;option4;indexCorrectOption'.  For example, with a paragraph about math, your response may look like this: '2+2=;2;3;4;5;2'''
graderPrompt = '''You are a short answer question grader. Based on the short answer prompt along with the response given above you must grade the response on a scale from 0-10 and then include an explanation of the grade. Ensure that your format looks like this: score;explanation'''

def FRQgenegrade(notes,numQs):
